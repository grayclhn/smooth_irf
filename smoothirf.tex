...
\if0\blind
{
  \title{\bf A method for smoothing Impulse Response Functions for
    discrete-time linear models}
  \author{Gray Calhoun\hspace{.2cm}\\
...
\if1\blind
{
  ...
  \bigskip
  \begin{center}
    {\LARGE\bf A method for smoothing Impulse Response Functions for
    discrete-time linear models}
\end{center}
  \medskip
} \fi
...
\noindent%
{\it Keywords:} IRF, Time series, VAR, Vector Autoregression
\vfill
